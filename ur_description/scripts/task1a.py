...
class aruco_tf(Node):
    ...
    def __init__(self):
        ...
        #colour image camera subscriber
        self.color_cam_sub=self.create_subscription(Image,'/camera/color/image_raw',self.colorimagecb,10)

        #depth colour image camera subscriber
    ...
    def detect_aruco(self,image):
        #default camera parameters of intel realsense
        ...
        #to detect aruco markers with their particular corners and marker id
    ...
    def process_image(self):
     try :
        ...
        #to detect aruco markers on the converted image 
        ...
        for i in range(len(self.ids)):
            ...
            #rotation matrix implementation for co-ordinate conversion 
            ...
            #sending transform from camera link
        ...
        #output window of aruco marker detection
